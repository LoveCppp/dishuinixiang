...
void main(int argc, char* argv[])
{
	...
	char path[] = "c://project/InjectDll.dll";	
	
	char outpath[] = "c://project/notepadnew.exe";
	LPSTR FILEPATH = path;
	...
	MoveRelocation(peFileBuffer);
	

	//打印导入表
	//PrintImportTable(peFileBuffer);
	//第一步：在DLL中新增一个节，并返回新增后的FOA
	//printBoundImportTable(peFileBuffer);
